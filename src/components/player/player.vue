  ...
  <div class="player" v-show="playList.length>0">
    <transition name="normal"
      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="middle">
          <div class="middle-l" ref="middleL" @click.prevent.stop="toggleClass">
          ...
          <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
            <div class="lyric-wrapper" @click.prevent.stop="toggleClass">
              <div v-if="currentLyric">
                <p class="text" v-for="(line,index) in currentLyric.lines" ref="lyricLine"
                   :class="{'current':currentLyricNum===index}" :key="line.time">{{line.txt}}</p>
              </div>
            </div>
          </scroll>
        </div>
        <div class="bottom">
          ...
          <div class="operators">
            <div class="icon i-left">
              <i :class="iconPlayMode" @click="playModeChange"></i>
            </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      toggleClass() {
        if (this.activeClass === 'cd') {
          this.$refs.middleL.style.display = 'none'
          this.$refs.lyricList.$el.style.display = 'block'
          this.activeClass = 'lyric'
        } else {
          this.$refs.middleL.style.display = 'block'
          this.$refs.lyricList.$el.style.display = 'none'
          this.activeClass = 'cd'
        }
      },
